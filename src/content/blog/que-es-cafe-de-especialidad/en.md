...
title: "What is specialty coffee and how to recognize it"
description: "Learn what specialty coffee is, how it's scored (SCA) and how to recognize a quality cup."
excerpt: "A clear guide to understanding specialty coffee: definition, the SCA scale, and how to identify it in the cup."
keywords: ["what is specialty coffee", "specialty coffee", "SCA coffee score", "quality coffee", "how to recognize specialty coffee", "specialty coffee colombia"]
date: 2026-06-18
updated: 2026-06-18
...
1. **Fragrance/Aroma:** the smell of the dry coffee and after brewing.
2. **Flavor:** the combined impression of all tastes.
3. **Aftertaste:** the persistence and quality of flavor after swallowing.
4. **Acidity:** not a flaw but a positive characteristic when well integrated; it can be citric, malic, tartaric, etc.
5. **Body:** the texture or weight of the coffee in the mouth.
6. **Balance:** how all the attributes interact and complement each other.
7. **Uniformity:** consistency across the different cups of the same sample.
8. **Clean cup:** absence of foreign or defective flavors.
9. **Sweetness:** the presence of natural fruit sweetness.
10. **Overall:** the cupper's holistic rating.
...
The best theory is the kind you verify in practice. If you want to find out firsthand what specialty coffee tastes like, we invite you to visit our [shops in Pereira](/en#cafe-bar), where we offer beans from our own family farm in the Eje Cafetero, crafted with the three main processing methods described above.

Our baristas are trained to guide you through the experience: arrive with curiosity and questions, and you will get answers — and probably a small demonstration. And if you want to go deeper, our [Coffee Tour](/en#tour) takes you directly to the farm so you can see with your own eyes where those notes come from before you identify them in the cup.

To learn more about our specific offer in Pereira, read our article on [specialty coffee in Pereira](/en/blog/specialty-coffee-pereira), where we detail the work we do on our farm and how we express it in the cup.
